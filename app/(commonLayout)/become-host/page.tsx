  ...
  const handleToHostRequest = async () => {
    ...
    if (user && user.email) {
      ...
      if (res.success && res.message) {
        ...
        toast.error(
          res.error.message || res.message || "your request is failed"
        );
      }
      console.log(res);
    } else {
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 text-base md:text-lg">
            Share your skills, ideas, and creativity with others.
            Become a host on our platform and manage your events
            easily while reaching a wider audience.
          </p>
